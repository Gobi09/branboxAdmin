		...
		$(document).ready(function() {
			...
			setInterval(function(){
				...
				success: function(json){
					...
					$.gritter.add(
					{
					title:"This is a Order notice!",
					text:"There is "+json.notification+" orders are arived",
...
<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
	...
	<div class="container-fluid" >
		...
		<li class="dropdown navbar-user">
			...
			<li class="divider"></li>
			<li><a href="<?php echo base_url(); ?>branboxController/adminLogout"> <i class="fa fa-sign-out"></i> Log Out</a></li>
		    </ul>
		</li>
	    </ul>
	...
	<div id="head" data-scrollbar="true" data-height="100%">
		...
		<!--    </a>-->
		<!--    <ul class="sub-menu">-->
		<!--	<li class="has-sub active"><a href="<?php echo base_url(); ?>branboxController/menuView"><b class="caret pull-right"></b>Menu</a>-->
		<!--	</li>-->
		<!--	<li class="has-sub active"><a href="<?php echo base_url(); ?>branboxController/subMenuView"><b class="caret pull-right"></b>Sub Menu</a>-->
		<!--	</li>-->
		<!--	<li class="has-sub active"><a href="<?php echo base_url(); ?>branboxController/subMenuItemView"><b class="caret pull-right"></b>Sub Menu Item</a>-->
		<!--	</li>-->
		<!--    </ul>-->
		<!--</li>-->
		<li class="has-sub active"><a href="<?php echo base_url(); ?>branboxController/adminUserView"><b class="caret pull-right"></b>Admin Users</a>
		</li>
		<li class="has-sub"><a href="<?php echo base_url(); ?>branboxController/businessUsersView"><b class="caret pull-right"></b>Business Users</a>
		</li>
