...
<head>
    <meta charset="utf-8" />
    <title>Branbox Admin | Manage Everything Here</title>
    ...
    <!-- bootstrap switches-->
	<!--<link href="<?php echo base_url(); ?>assets/plugins/bootstrap-switches/docs/css/bootstrap3/bootstrap-switch.css" rel="stylesheet" />-->
	<!--<script src="<?php echo base_url(); ?>assets/plugins/bootstrap-switches/docs/js/jquery.min.js"></script>-->
	<!--<script src="<?php echo base_url(); ?>assets/bootstrap-switches/docs/js/highlight.js"></script>-->
	<!--<script src="<?php echo base_url(); ?>assets/bootstrap-switches/dist/js/bootstrap-switch.js"></script>-->
	<!--<script src="<?php echo base_url(); ?>assets/bootstrap-switches/docs/js/main.js"></script>-->
    <!-- bootstrap switches -->
...
<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
	...
	<div class="container-fluid" >
		...
		<a href="<?php echo base_url(); ?>branboxController" class="navbar-brand"><span ><img src="<?php echo base_url(); ?>assets/img/logo.jpg" class="img-responsive" data-id="login-cover-image" alt="" style=" height: 41px; width: 102px;" /></span> </a>
		...
		<li class="dropdown navbar-user">
			...
			<li class="divider"></li>
			<li><a href="<?php if($this->session->userdata('role')=='Business') echo base_url("branboxController/Logout"); else echo base_url("branboxController/adminLogout") ?>"> <i class="fa fa-sign-out"></i> Log Out</a></li>
		    </ul>
		</li>
	    </ul>
	...
	<div id="head" data-scrollbar="true" data-height="100%">
		...
		<li class="" id="page1"><a href="<?php echo base_url(); ?>branboxController/dashboard"><i class="fa fa-laptop"></i><span>Dashboard</span></a></li>
		<?php if($this->session->userdata('role')=='Business'){ ?>
		...
		<li class="has-sub " id="11-a">
		    ...
		    <ul class="sub-menu">
			<li class="" id="page11"><a href="<?php echo base_url(); ?>branboxController/tableRequest"><i class="fa fa-align-left "></i> Booked Table</a>
			</li>
			<li class="" id="page12"><a href="<?php echo base_url(); ?>branboxController/orderedItem"><i class="fa fa-align-left "></i> Ordered Items</a>
			</li>
		    </ul>
		</li>
		...
		<li class="" id="page13"><a href="<?php echo base_url(); ?>branboxController/adminUserView"><b class="caret pull-right"></b>Admin Users</a>
		</li>
		<li class="" id="page14"><a href="<?php echo base_url(); ?>branboxController/restuarantView"><b class="caret pull-right"></b>Business Users</a>
		</li>
	    <?php }?>
